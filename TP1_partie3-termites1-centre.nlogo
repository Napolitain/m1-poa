turtles-own [etape] ;; un attribut pour représenter l'étape du comportement de la termite

;; séquence d'action :
;; 1 chercherBrindille : je cherche et ramasse une brindille (et je m'éloigne rapidement)
;; 2 chercherTas : quand j'ai ramassé une brindille je cherche un nouveau tas
;; 3 poser : quand je suis sur un tas, je cherche un emplacement vide et je pose
;; 4 fuir : quand j'ai posé, je m'éloigne rapidement. quand je ne suis plus sur un tas, je boucle à chercherBrindille
...
;; pour une jolie simulation, faites en sorte que vos agents ne "jouent" qu'une seule fois par tick (évitez les appels récursifs!)
to go
  ask turtles
  [
...
to find-centre  ;; turtle procedure -- remplacé par deposer au centre
